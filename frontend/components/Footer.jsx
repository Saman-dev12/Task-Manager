    ...
    <footer className="text-white body-font bg-blue-900">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-center md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-evenly  text-white  ">
            <svg
            ...
            <span className="ml-3 text-xl">Taskings</span>
          </a>
      ...
      <div className="bg-blue-800">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-white text-sm text-center sm:text-left">
            © 2023 -{""}
            <a
              href="https://www.linkedin.com/in/samanpreet-singh-921996225/"
